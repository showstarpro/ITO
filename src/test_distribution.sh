...
# OUTPATH=/lpai/output/models/ito-cc12m-sub2lr1e3b4k/downstreams/cls_zeroshoshot-imgs-r
# BS=128
# MODEL="ViT-B-16"
# #MODEL="ViT-B-16-512"
# #MODEL="ViT-L-16"
...
OUTPATH=/lpai/output/models/ito_mulitpos-ITO_reca_sub2_mulitpos_lr1e3_bs2048/downstreams/linear_probe-stanf
BS=128
MODEL="ViT-B-16"
#MODEL="ViT-B-16-512"
#MODEL="ViT-L-16"
...
# CHKPNT=/lpai/volumes/jfs-data-lhp-bd-ga/ito-cc12m/sub2lr1e3b2k/epoch_30.pt
# CHKPNT=/lpai/volumes/jfs-data-lhp-bd-ga/ito-cc12m/sub2lr1e3b4k/epoch_30.pt
# CHKPNT=/lpai/volumes/jfs-data-lhp-bd-ga/ito_cc3m/su2mpl3e3b4k/epoch_30.pt
CHKPNT=/lpai/volumes/jfs-data-lhp-bd-ga/ito_mulitpos/ITO_reca_sub2_mulitpos_lr1e3_bs2048/checkpoints/epoch_30.pt
...
# CUDA_VISIBLE_DEVICES=3 python -m open_clip_train.main --logs=$OUTPATH --pretrained $CHKPNT --batch-size=$BS --workers=2 --model $MODEL --cifar10=$CIFAR10 --test-linear
# CUDA_VISIBLE_DEVICES=3 python -m open_clip_train.main --logs=$OUTPATH --pretrained $CHKPNT --batch-size=$BS --workers=2 --model $MODEL --cifar100=$CIFAR100 --test-linear
# CUDA_VISIBLE_DEVICES=2 python -m open_clip_train.main --logs=$OUTPATH --pretrained $CHKPNT --batch-size=$BS --workers=2 --model $MODEL --imagenet-val=$IMAGENETVAL --imagenet-train=$IMAGENETTRAIN --test-linear
# CUDA_VISIBLE_DEVICES=3 python -m open_clip_train.main --logs=$OUTPATH --pretrained $CHKPNT --batch-size=$BS --workers=2 --model $MODEL --flowers-102=$FLOWERS102 --test-linear
...
CUDA_VISIBLE_DEVICES=3 python -m open_clip_train.main --logs=$OUTPATH --pretrained $CHKPNT --batch-size=$BS --workers=2 --model $MODEL --stanford=$STANFORD --test-linear
