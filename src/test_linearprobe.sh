...
OUTPATH=/lpai/output/models/openclip/downstreams/linear_probe-stanford_cars
BS=128
MODEL="ViT-B-16"
#MODEL="ViT-B-16-512"
#MODEL="ViT-L-16"
...
# CUDA_VISIBLE_DEVICES=6 python -m open_clip_train.main --logs=$OUTPATH --pretrained $CHKPNT --batch-size=$BS --workers=2 --model $MODEL --imagenet-val=$IMAGENETVAL --imagenet-train=$IMAGENETTRAIN
