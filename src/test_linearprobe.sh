...
OUTPATH=/lpai/output/models/siglip12m1e3/downstreams/linear_probe-cifar100
BS=128
...
# CUDA_VISIBLE_DEVICES=3 python -m open_clip_train.main --logs=$OUTPATH --pretrained $CHKPNT --batch-size=$BS --workers=2 --model $MODEL --imagenet-val=$IMAGENETVAL --imagenet-train=$IMAGENETTRAIN
