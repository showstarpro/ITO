...
from open_clip import get_input_dtype, get_tokenizer, build_zero_shot_classifier, \
    IMAGENET_CLASSNAMES, OPENAI_IMAGENET_TEMPLATES, IMAGENET_A_CLASSNAMES, IMAGENET_R_CLASSNAMES, CIFAR10_CLASSNAMES, CIFAR100_CLASSNAMES, \
        FLOWERS_CLASSNAMES, STANFORD_CLASSNAMES, IMAGENET_O_CLASSNAMES, FOOD_CLASSNAMES, PETS_CLASSNAMES,\
...
def zero_shot_eval(model, data, epoch, args, tokenizer=None):
    ...
    if 'pets' in data:
        top1, top5 = run(model, classifier, data['pets'].dataloader, args)
        results['pets-zeroshot-val-top1'] = top1
        results['pets-zeroshot-val-top5'] = top5
